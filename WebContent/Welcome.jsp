      ...
      <div class="container">
        <div class="row align-items-center py-5">
          <div class="col-5 col-lg-7 mx-auto mb-5 mb-lg-0">
            <div class="pr-lg-5"><img src="bootstrap/img/medical.jpg" alt="" class="img-fluid"></div>
          </div>
          <div class="col-lg-5 px-lg-4">
            ...
            <form action="AdminLogin" method="post" class="mt-4">
              ...
              <input type="submit" class="btn btn-primary shadow px-5" value="Log In">
              Don't have an account? <a href="Patient_SignUp.jsp">Create an Account</a>
            </form>
          </div>
        </div>
